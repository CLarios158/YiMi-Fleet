...
class Configuracion extends Component {
    ...
    componentDidMount() {
        ...
        if (this.state.isConnected != false) {
            ...
            this.focusListener = navigation.addListener('didFocus', () => {
                ...
                axios.post('http://35.203.57.92:3000/consultar_usuario', { id_usuario: this.state.id_usuario })
                    .then(response => {
                        response.data.data.forEach(element => {
                            this.setState({
    ...
    correo = () => {
        if (this.state.isConnected != false) {
            this.props.navigation.navigate('Correo', {
                id_usuario: this.state.id_usuario, nombre: this.state.nombre, apellido: this.state.apellido, curp: this.state.curp,
    ...
    ciudad = () => {
        if (this.state.isConnected != false) {
            this.props.navigation.navigate('Ciudad', {
                id_usuario: this.state.id_usuario, nombre: this.state.nombre, apellido: this.state.apellido, curp: this.state.curp,
                correo: this.state.correo, telefono: this.state.telefono, foto: this.state.foto, id_ciudad: this.state.id_ciudad, id_tipo_conductor: this.state.id_tipo_conductor
            })
        }
    ...
    pago = () => {
        if (this.state.isConnected != false) {
            axios.post('http://35.203.57.92:3000/consultar_cuenta_bancaria', { id_usuario: this.state.id_usuario })
                .then(response => {
                    response.data.data.forEach(element => {
                        this.setState({
                    ...
                    this.props.navigation.navigate('TipoPago', {
                        id_usuario: this.state.id_usuario, nombre_propietario: this.state.nombre_propietario, apellido_propietario: this.state.apellido_propietario, num_cuenta: this.state.num_cuenta, clabe: this.state.clabe,
