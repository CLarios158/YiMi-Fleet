    ...
    CargarDocumento = () =>{
        if(this.state.isConnected != false){
            ...
            .then(response => {
                ...
                Alert.alert(
                    'Aviso',
                    'Tu Foto de Perfil han sido enviada para su validación, se te notificará cuando esto haya sucecido.',
                    [
                ...
                <Grid>
                    ...
                    <Row style={{marginTop:30}}>
                        <Col style={{display:'flex', alignItems:'center',alignContent:'center'}}>
                            <Thumbnail style={{ height: 300, width: 300, borderRadius:200}} square source= {{uri:this.state.image}} />
                        </Col>
                    </Row>
                    <Row>
