...
class LicenciaConducir extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarLicenciaSC',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:2, estado: this.state.estado})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSC',{id_usuario: this.state.id_usuario, id_cat_doc:2, estado: this.state.estado})
    };
