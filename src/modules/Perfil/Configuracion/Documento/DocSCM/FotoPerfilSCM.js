...
class FotoPerfil extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarFotoSCM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:3})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSCM',{id_usuario: this.state.id_usuario, id_cat_doc:3, estado: this.state.estado})
    };
        ...
        <Container>
            <Content>
                <Grid>
                    ...
                    <Row>
                        <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
                            <Text style = {{textAlign:'center'}}>Asegúrese que la fotografía cuente con los siguientes puntos:</Text>
                        </Col>
                    </Row>
                    <Row>
                        <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
