...
class CartaAntecedentesPenales extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarCartaSCM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:8})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSCM',{id_usuario: this.state.id_usuario, id_cat_doc:8, estado: this.state.estado})
    };
