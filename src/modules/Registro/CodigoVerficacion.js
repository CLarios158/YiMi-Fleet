...
import { Container, View, Content, Text, Input, Form, Button, Grid, Col, Row, H3} from 'native-base';
        ...
        <Content>
          <Grid>
            ...
            <Row style={{marginTop:10}}>
              <Col><Button disable={true} transparent onPress={this.sendCode}><Text style={{color:'black'}}>No recibí el código ></Text></Button></Col>
