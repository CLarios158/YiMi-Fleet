...
import { Container, Content, View, Text, Grid, Col, Row, Radio, Button} from 'native-base';
...
class TipoPago extends Component {
    ...
    componentDidMount(){
        ...
        axios.post('http://35.203.42.33:3003/webservice/comision_fija_plataforma')
        .then(response => {
        ...
        axios.post('http://35.203.42.33:3003/webservice/comision_porcentaje_plataforma')
        .then(response => {
            response.data.datos.forEach(element => {
              this.setState({
                ...
                <Container>
                    <Content>
                        <Grid>
                            ...
                            <Row><Col style={{marginLeft:20, marginTop:20}}><Text>Seleccione nuevo tipo de pago</Text></Col></Row>
                            <Row>
