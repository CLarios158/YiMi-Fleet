...
class IdentificacionOficial extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarIdentificacionSNCM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:1})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSNCM',{id_usuario: this.state.id_usuario, id_cat_doc:1, estado: this.state.estado})
    };
