...
import { Container, Content, View, Text, Button,Grid, Col, Row} from 'native-base';
    ...
    CargarDocumento = () =>{
        if(this.state.isConnected == true){
            ...
            if(this.state.estado != 0){
                axios.post('http://35.203.57.92:3000/registrar_documento',{archivo: this.state.archivo, id_usuario: this.state.id_usuario, id_cat_documento: this.state.id_cat_documento, tipo_rfc: null})
                .then(response => {
                    console.log('Resgistro .key');
                    this.props.navigation.navigate('DocumentoSNC', {id_usuario: this.state.id_usuario});
                })
