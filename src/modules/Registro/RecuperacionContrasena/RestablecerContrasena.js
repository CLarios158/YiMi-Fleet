...
class RestablecerContraseña extends Component {
    ...
    sendCodePhone = () => {
        if (this.state.isConnected != false) {
            ...
            this.props.navigation.navigate('CodigoVerificacionContrasena', { id_usuario: this.state.id_usuario, telefono: this.state.telefono });
        }
    }

    sendCodeEmail = () => {
        if (this.state.isConnected != false) {
            axios.post('http://35.203.57.92:3000/mail', { correo: this.state.correo });
