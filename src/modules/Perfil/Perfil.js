...
class Perfil extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            estatus: '', vigencia: '', foto: '', telefono: '',
            correo: '', loading: false, isConnected: true
        }
    }
    ...
    componentDidMount() {
        ...
        this.focusListener = navigation.addListener('didFocus', () => {
            if (this.state.isConnected != false) {
                axios.post('http://35.203.57.92:3000/VigenciaStatus', { id_usuario: this.state.id_usuario })
                    .then(response => {
                                        ...
                                        <CardItem>
                                            <Body>
                                                <Row>
                                                    ...
                                                    <Col style={{ width: '40%' }}>
                                                        <Text style={{ fontWeight: 'bold', marginLeft: 1, fontSize: 16, paddingTop: 15 }}>{this.state.nombre}</Text>
                                                    </Col>
                                                    <Col style={{ width: '30%' }}>
