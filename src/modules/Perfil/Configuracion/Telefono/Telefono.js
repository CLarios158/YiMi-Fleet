import { Container, Content, View, Text, Grid, Col, Row, Button, Input, H3 } from 'native-base';
...
class Telefono extends Component {
    ...
    SendCode = () => {
        if (this.state.isConnected != false) {
            ...
            this.props.navigation.navigate('CodigoV', {
            ...
            <Container>
                <Content>
                    <Grid>
                        ...
                        <Row><Col style={{ marginLeft: 20, marginTop: 20 }}><H3>Ingresa su nuevo teléfono para guardar</H3></Col></Row>
                        <Row>
