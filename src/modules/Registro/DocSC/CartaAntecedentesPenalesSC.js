...
class CartaAntecedentesPenales extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarCartaSC',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:8, estado: this.state.estado})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSC',{id_usuario: this.state.id_usuario, id_cat_doc:8, estado: this.state.estado})
    };
                    ...
                    <Grid>
                        ...
                        <Row>
                            <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
                                <Text style = {{textAlign:'center', fontWeight:'bold'}}>Carta de Antecedentes Penales</Text>
                            </Col>
                        </Row>
                        <Row>
                            <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
                        ...
                        <Row>
                            <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
                                <Text style = {{textAlign:'center'}}>Sube una foto de tu Carta de no antecedentes penales que no sea mayor a 3 meses de expedición.</Text>
                            </Col>
                        </Row>
                        <Row>
                            <Col style={{display:'flex', alignItems:'center',alignContent:'center', marginTop:10, marginLeft:20, marginRight:20}}>
...
export default CartaAntecedentesPenales;