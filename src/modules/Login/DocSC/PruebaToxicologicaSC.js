...
class PruebaToxicologica extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarPruebaTSC',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:10, estado: this.state.estado})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSC',{id_usuario: this.state.id_usuario, id_cat_doc:10, estado: this.state.estado})
    };
