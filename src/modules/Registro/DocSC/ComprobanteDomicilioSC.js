...
class ComprobanteDomicilio extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarComprobanteSC',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:9, estado: this.state.estado})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSC',{id_usuario: this.state.id_usuario, id_cat_doc:9, estado: this.state.estado})
    };
