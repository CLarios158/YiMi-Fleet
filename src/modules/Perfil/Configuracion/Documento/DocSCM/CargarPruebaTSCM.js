...
class CargarPruebaT extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    CargarDocumento = () =>{
        if(this.state.isConnected != false){
            ...
            .then(response => {
                console.log('Modifico Prueba Toxi');
                Alert.alert(
                    'Aviso',
                    'Tu Prueba Toxicológico 3 Elementos han sido enviada para su validación, se te notificará cuando esto haya sucecido.',
                    [
