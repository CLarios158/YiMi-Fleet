...
class FotoPerfil2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            image: null,
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarFotoSNC',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:3, estado: this.state.estado})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraSNC',{id_usuario: this.state.id_usuario, id_cat_doc:3, estado: this.state.estado})
    };
