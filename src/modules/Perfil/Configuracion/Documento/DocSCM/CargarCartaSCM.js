...
class CargarCarta extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    CargarDocumento = () =>{
        if(this.state.isConnected != false){
            ...
            .then(response => {
                console.log('Modifico Carta');
                Alert.alert(
                    'Aviso',
                    'Tu Carta de No Antecendetes Penales han sido enviada para su validación, se te notificará cuando esto haya sucecido.',
                    [
